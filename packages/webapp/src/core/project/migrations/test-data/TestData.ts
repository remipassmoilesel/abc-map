...
import type { AbcProjectManifest010 } from '../dependencies/010-project-types';
...
import type { AbcProjectManifest090 } from '../dependencies/090-project-types';
import type { AbcProjectManifest040 } from '../dependencies/040-project-types';
import type { AbcProjectManifest050 } from '../dependencies/050-project-types';
...
import type { AbcProjectManifest100 } from '../dependencies/100-project-types';
...
export class TestData {
  public static async project01(): Promise<MigrationProject<AbcProjectManifest010>> {
    return this.readFile(`${import.meta.dirname}/project-0.1.abm2`) as Promise<MigrationProject<AbcProjectManifest010>>;
  }

  public static async project020(): Promise<MigrationProject<AbcProjectManifest020>> {
    return this.readFile(`${import.meta.dirname}/project-0.2.0.abm2`) as Promise<MigrationProject<AbcProjectManifest020>>;
  }

  public static async project030(): Promise<MigrationProject<AbcProjectManifest030>> {
    return this.readFile(`${import.meta.dirname}/project-0.3.0.abm2`) as Promise<MigrationProject<AbcProjectManifest030>>;
  }

  public static async project040(): Promise<MigrationProject<AbcProjectManifest040>> {
    return this.readFile(`${import.meta.dirname}/project-0.4.0.abm2`) as Promise<MigrationProject<AbcProjectManifest040>>;
  }

  public static async project050(): Promise<MigrationProject<AbcProjectManifest050>> {
    return this.readFile(`${import.meta.dirname}/project-0.5.0.abm2`) as Promise<MigrationProject<AbcProjectManifest050>>;
  }

  public static async project060(): Promise<MigrationProject<AbcProjectManifest060>> {
    return this.readFile(`${import.meta.dirname}/project-0.6.0.abm2`) as Promise<MigrationProject<AbcProjectManifest060>>;
  }

  public static async project070(): Promise<MigrationProject<AbcProjectManifest070>> {
    return this.readFile(`${import.meta.dirname}/project-0.7.0.abm2`) as Promise<MigrationProject<AbcProjectManifest070>>;
  }

  public static async project080(): Promise<MigrationProject<AbcProjectManifest080>> {
    return this.readFile(`${import.meta.dirname}/project-0.8.0.abm2`) as Promise<MigrationProject<AbcProjectManifest080>>;
  }

  public static async project090(): Promise<MigrationProject<AbcProjectManifest090>> {
    return this.readFile(`${import.meta.dirname}/project-0.9.0.abm2`) as Promise<MigrationProject<AbcProjectManifest090>>;
  }

  public static async project100(): Promise<MigrationProject<AbcProjectManifest100>> {
    return this.readFile(`${import.meta.dirname}/project-1.0.0.abm2`) as Promise<MigrationProject<AbcProjectManifest100>>;
  }

  public static async project110(): Promise<MigrationProject<AbcProjectManifest110>> {
    return this.readFile(`${import.meta.dirname}/project-1.1.0.abm2`) as Promise<MigrationProject<AbcProjectManifest110>>;
  }

  public static async project110_public(): Promise<MigrationProject<AbcProjectManifest110>> {
    return this.readFile(`${import.meta.dirname}/project-1.1.0_public.abm2`) as Promise<MigrationProject<AbcProjectManifest110>>;
  }

  public static async project130(): Promise<MigrationProject<AbcProjectManifest130>> {
    return this.readFile(`${import.meta.dirname}/project-1.3.0.abm2`) as Promise<MigrationProject<AbcProjectManifest130>>;
  }

  public static async project140(): Promise<MigrationProject<AbcProjectManifest>> {
    return this.readFile(`${import.meta.dirname}/project-1.4.0.abm2`) as Promise<MigrationProject<AbcProjectManifest>>;
  }
  ...
  private static async readFile(path: string): Promise<MigrationProject<unknown>> {
    ...
    const blobFiles = files.map((f) => ({
      path: f.path,
      content: new Blob([f.content as unknown as ArrayBuffer]),
    }));
