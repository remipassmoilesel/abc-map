...
import type { AbcWindow, E2eMap } from '@abc-map/shared';
import Chainable = Cypress.Chainable;

export class SharingLayoutMap {
  public static getComponent() {
    return cy.get(`[data-cy=sharing-layout-map]`);
  }
  ...
  public static getReference(): Chainable<E2eMap> {
    return this.getComponent() // We fetch component to wait for initialization
      ...
      .then((_window) => {
        ...
        const map = window.abc.sharingLayoutMap;
