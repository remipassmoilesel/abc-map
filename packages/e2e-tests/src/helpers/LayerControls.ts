...
import { WmsConstants } from './WmsConstants.js';
import { WmtsConstants } from './WmtsConstants.js';
import { XyzConstants } from './XyzConstants.js';
...
export class LayerControls {
  ...
  public static zoomOnActiveLayer(): Cypress.Chainable<any> {
    return cy.get('[data-cy=zoom-on-layer]').click();
  }
}
