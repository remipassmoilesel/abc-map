...
export class RemoveLayoutTextFrameChangeset extends Changeset {
  public static create(layout: AbcLayout, frame: AbcTextFrame): RemoveLayoutTextFrameChangeset {
    const { project } = getServices();
    return new RemoveLayoutTextFrameChangeset(project, layout, frame);
  }
