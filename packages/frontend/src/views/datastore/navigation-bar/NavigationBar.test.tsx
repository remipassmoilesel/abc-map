...
describe('NavigationBar', () => {
  ...
  describe('With few pages', () => {
    it('and low active value', () => {
      abcRender(<NavigationBar offset={0} limit={10} total={50} onClick={onClick} maxButtons={7} />);
    ...
    it('and medium active value', () => {
      abcRender(<NavigationBar offset={20} limit={10} total={50} onClick={onClick} maxButtons={7} />);
    ...
    it('and high active value', () => {
      abcRender(<NavigationBar offset={40} limit={10} total={50} onClick={onClick} maxButtons={7} />);
  ...
  describe('With lot of pages', () => {
    it('and low active value', () => {
      abcRender(<NavigationBar offset={0} limit={10} total={1000} onClick={onClick} maxButtons={7} />);
    ...
    it('and medium active value', () => {
      abcRender(<NavigationBar offset={490} limit={10} total={1000} onClick={onClick} maxButtons={7} />);
    ...
    it('and high active value', () => {
      abcRender(<NavigationBar offset={990} limit={10} total={1000} onClick={onClick} maxButtons={7} />);
