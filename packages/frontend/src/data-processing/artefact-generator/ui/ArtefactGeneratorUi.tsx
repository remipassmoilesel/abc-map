...
import Cls from './ArtefactGeneratorUi.module.scss';
...
const logger = Logger.get('ArtefactGeneratorUi.tsx');
...
function ArtefactGeneratorUi(props: Props) {
...
export default withTranslation()(ArtefactGeneratorUi);
