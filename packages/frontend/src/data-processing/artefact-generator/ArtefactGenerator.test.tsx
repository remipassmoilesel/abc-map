...
import { ArtefactGenerator } from './ArtefactGenerator';
...
import { wmsCapabilities, wmtsCapabilities } from './ArtefactGenerator.test.data';

describe('ArtefactGenerator', () => {
  ...
  let generator: ArtefactGenerator;

  beforeEach(() => {
    services = newTestServices();
    previewExporter = sinon.createStubInstance(PreviewExporter);
    progressHandler = sinon.stub();
    generator = new ArtefactGenerator(services as unknown as Services, previewExporter);
