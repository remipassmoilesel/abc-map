 ...
 *
 * Informations used here are NOT SAFE as they are PUBLIC.
 */
export const AnonymousUser: AbcUser = {
  // An id will be generated by backend
  id: 'anonymous-user',
  email: 'anonymous-user@abc-map.fr',
  // This password is not safe, it must be used only for anonymous users
