...
import { hashRequestSource, logger } from './hashRequestSource.js';
...
describe('hashRequestSource()', () => {
  it('should work', () => {
    ...
    assert.deepEqual(hashRequestSource(req1), '8f9b9ec54448559a741751de7057c1e368e19a1b9cf8a4496be48b3ce93751ab');
